...
router.post('/', 
  [
    ...
    [
      ...
      check('password', 'la contraseña debe iniciar con 1 mayuscula y contener al menos 1 número. Al menos 6 caracteres y un carácter especial (@#$%^*).')
...
router.put('/:id', 
  [
    ...
    [
      ...
      .matches(/^(?=.*\d)(?=.*[a-zA-Z])[A-Za-z\d!@#$%^&*+=]{6,15}$/).withMessage('La contraseña debe ser entre 6 a 15 caracteres, contener al menos 1 mayuscula, 1 número y un caracter especial (@#$%^*)'),
